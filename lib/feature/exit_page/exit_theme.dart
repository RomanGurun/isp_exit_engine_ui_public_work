...
class ExitTextStyles {
  ...
  static TextStyle small({Color? color}) =>
      GoogleFonts.dmSans(fontSize: 12, color: color ?? ExitColors.textMuted);
}

//=============== Text Style========================

// ============Dummy Data -swap with API models==================
...
const dummyEmployee = ExitEmployee(
  name: "John Smith",
  employeeId: 'EMP-4821',
  jobTitle: 'Field_Technician',
  department: 'Field Operation',
  supervisor: 'Ahmed Al-Rashid',
  dateOfJoining: '12 March 2021',
  lastWorkingDate: '31 March 2026',
  interviewDate: '26 March 2026',
...
const exitReasons = [
  ...
  'Career Growth /Promotion opportuntity elseWhere',

                ...
                _FieldRow(
                  children: [
                    ExitReadOnlyField(
                      ...
                      value: e.lastWorkingDate,
                    ),
                    ExitReadOnlyField(
                      label: 'Interview Date',
                      value: e.interviewDate,
                    ),
                  ],
                ),
                SizedBox(height: 12.h),
                ...
                _FieldRow(
                  children: [
                    ExitReadOnlyField(
                      ...
                      value: e.yearsOfService,
                    ),
                    ExitReadOnlyField(
                      label: 'Interviewer Name',
                      value: e.interviewerName,
                    ),
                  ],
                ),
              ],
    ...
    return Row(
      children: children
          .map(
            (w) => Expanded(
              child: Padding(
                padding: EdgeInsets.only(right: children.last == w ? 0 : 10.w),
                child: w,
              ),
            ),
          )
